...
export default function Assessments() {
  ...
  const staticAssessments: Assessment[] = [
    ...
    },
    {
      ...
      downloadJsonUrl: "/api/assessments/download/cyber-resilience",
      aliases: [],
      keywords: ["cyber resilience", "resilience", "security", "threat"],
      categoryTitles: ["Cyber Security Strategy", "Security Awareness & Training", "Security Monitoring & Detection", "Data Protection & Privacy"]
    },
    {
      id: "digital-work-analytics",
      title: "Digital Work Analytics Assessment",
      description: "This 16-point assessment helps organizations evaluate their digital work environment through the lens of visibility, focus, wellness, and productivity optimization.",
      icon: "📊",
      gradient: "from-teal-500 to-blue-500",
      status: "Active",
      lastUpdated: Math.floor(Date.now() / 1000) - 1800,
      runAssessmentUrl: "/lmx/assessments/run/digital-work-analytics",
      viewReportUrl: "/lmx/assessments/report/digital-work-analytics",
      downloadJsonUrl: "/api/assessments/download/digital-work-analytics",
      aliases: ["dwa"],
      keywords: ["digital work", "analytics", "productivity", "wellness"],
      categoryTitles: ["Digital Work Strategy", "Data Collection & Infrastructure", "Analytics & Insights", "Real-time Dashboards & Reporting"]
    },
    {
      id: "new-client-comprehensive",
      title: "New Client Assessment (Comprehensive)",
      description: "This 72-point assessment evaluates new client technical maturity, risk factors, and service requirements across 12 critical focus areas. Designed for comprehensive client onboarding.",
      icon: "📋",
      gradient: "from-yellow-500 to-orange-500",
      status: "Active",
      lastUpdated: Math.floor(Date.now() / 1000) - 2100,
      ...
      viewReportUrl: "/lmx/assessments/report/new-client-comprehensive",
      downloadJsonUrl: "/api/assessments/download/new-client-comprehensive",
      aliases: ["new-client-comprehensive"],
      keywords: ["infrastructure", "hosting", "server", "virtualization", "security", "firewall", "endpoint", "mfa"],
      categoryTitles: ["Business Strategy & Operations", "Technology Strategy & Infrastructure", "Security & Compliance", "Process Optimization & Automation"]
    },
    {
      id: "new-client-quick",
      title: "New Client Assessment (Quick)",
      description: "This 24-point assessment provides rapid evaluation of new client technical maturity and risk factors across 6 critical focus areas. Designed for MSPs who need quick insights.",
      icon: "📋",
      gradient: "from-pink-500 to-rose-500",
      status: "Active",
      lastUpdated: Math.floor(Date.now() / 1000) - 2400,
      ...
      viewReportUrl: "/lmx/assessments/report/new-client-quick",
      downloadJsonUrl: "/api/assessments/download/new-client-quick",
      aliases: ["new-client-quick"],
      keywords: ["quick", "rapid", "onboarding", "evaluation"],
      categoryTitles: ["Quick Technical Assessment", "Risk Evaluation", "Service Requirements", "Implementation Planning"]
    },
    {
      id: "technology-alignment",
      title: "Technology Alignment Assessment",
      description: "This 27-point assessment evaluates client technology alignment across six core service areas, designed to help MSPs understand current state, identify gaps, and plan strategic improvements.",
      icon: "🔍",
      ...
      downloadJsonUrl: "/api/assessments/download/technology-alignment",
      aliases: ["technology"],
      keywords: ["technology", "alignment", "architecture", "governance"],
      categoryTitles: ["Technology Strategy", "Technology Architecture", "Technology Governance", "Technology Portfolio Management"]
    }
  ];
