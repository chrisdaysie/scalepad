          ...
          <>
            ...
            {activeTab === 'hardware' && (
              <div className="space-y-8">
                {/* Hardware Stats */}
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">💻 Hardware Lifecycle Report</h2>
                ...
                {/* Software Stats */}
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">🖥️ Software Summary</h2>
